...
export const GRASS_FIELD_COLOR = "#78C866";
export const GRASS_PATCH_COLOR = "#4E9A3E";
export const GRASS_BLADE_COUNT = 14000;
export const GRASS_BLADE_BASE_WIDTH = 0.1;
export const GRASS_BLADE_BASE_HEIGHT = 0.68;
export const GRASS_BLADE_WIDTH_VARIANCE = 0.45;
export const GRASS_BLADE_HEIGHT_VARIANCE = 0.55;
...
export const GRASS_WIND_STRENGTH = 0.21;
export const GRASS_WIND_SPEED = 1.1;
...
export const GRASS_ROOT_DARKEN = 0.52;
