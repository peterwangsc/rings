...
export const PLAYER_WALK_SPEED = 2.8 * PLAYER_SPEED_SCALAR;
export const PLAYER_RUN_SPEED = 4.5 * PLAYER_SPEED_SCALAR;
...
export const PLAYER_GROUND_CAST_DISTANCE =
  PLAYER_CAPSULE_HALF_HEIGHT + PLAYER_CAPSULE_RADIUS + 0.12;
export const GROUNDED_GRACE_SECONDS = 0.08;
...
export const TREE_COUNT = 82;
export const TREE_FIELD_RADIUS = GROUND_HALF_EXTENT - 3;
export const TREE_CLEARING_RADIUS = 11;
export const TREE_MIN_SPACING = 2.2;
export const TREE_MAX_SLOPE = 0.95;
export const TREE_TRUNK_BASE_HEIGHT = 2.2;
export const TREE_TRUNK_HEIGHT_VARIANCE = 1.2;
export const TREE_TRUNK_BASE_RADIUS = 0.16;
export const TREE_TRUNK_RADIUS_VARIANCE = 0.08;
export const TREE_BRANCH_LEVELS = 3;
export const TREE_CANOPY_BASE_HEIGHT = 2.9;
export const TREE_CANOPY_HEIGHT_VARIANCE = 1.5;
export const TREE_CANOPY_BASE_RADIUS = 1.1;
export const TREE_CANOPY_RADIUS_VARIANCE = 0.55;
export const TREE_CANOPY_VERTICAL_OFFSET = 0.22;
export const TREE_TRUNK_COLOR = "#604531";
export const TREE_CANOPY_DARK_COLOR = "#3B7C3A";
export const TREE_CANOPY_LIGHT_COLOR = "#57A650";
