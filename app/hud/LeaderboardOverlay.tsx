...
export function LeaderboardOverlay({
  ...
  return (
    <div className="ui-nonselectable pointer-events-none absolute left-1/2 top-5 z-30 w-[min(64rem,calc(100vw-1.5rem))] -translate-x-1/2 rounded-2xl border border-cyan-100/35 bg-black/72 p-3 text-cyan-50 shadow-[0_18px_55px_rgba(0,0,0,0.55)] backdrop-blur-md sm:p-4">
      <div className="mb-3 flex items-center justify-between border-b border-cyan-200/20 pb-2">
        ...
        <p className="text-[10px] uppercase tracking-[0.12em] text-cyan-100/60"></p>
      </div>
